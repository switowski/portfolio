// https://unpkg.com/littlefoot@3.4.1/dist/littlefoot.js
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? t(exports)
    : 'function' == typeof define && define.amd
    ? define(['exports'], t)
    : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).littlefoot = {}));
})(this, function (e) {
  'use strict';
  var T =
  ...
  var f = t(function (o) {
        ...
        (e = n(t, n(o.exports))),
          ...
          (w = function (r) {
            ...
            function t(t, n) {
              e[t] = r[t]
                ? function (e) {
                    return (o = !o) ? { value: g(r[t](e)), done: 'return' === t } : n ? n(e) : e;
                  }
                : n;
            }
          }),
    ...
    g = t(function (e, t) {
      (t.__esModule = !0),
        ...
        (t.getStyle = function (e, t) {
          var n,
            r = ((null === (n = e.ownerDocument) || void 0 === n ? void 0 : n.defaultView) || window).getComputedStyle(
              e
            );
    ...
    i = t(function (e, t) {
      ...
      function y(e) {
        return e
          ? g.getStyle(e, 'fontSize') || y(e.parentElement)
          : g.getStyle(window.document.documentElement, 'fontSize');
      }
      t.pixels = function e(t, n) {
        var r,
          ...
          l =
            null !==
              (o = null === (r = null == n ? void 0 : n.ownerDocument) || void 0 === r ? void 0 : r.defaultView) &&
            void 0 !== o
              ? o
              : window,
  ...
  function y(e) {
    ...
    return { top: n, bottom: window.innerHeight - n };
  }
  function w(e) {
      ...
      reposition: function () {
        ...
        S(p) &&
          ((d.style.maxHeight =
            ...
            (c = y(f)),
            (l = _(a, c)),
            (s = parseInt(g.getStyle(a, 'marginTop'), 10)),
            Math.min(u, c[l] - s - 15) + 'px')),
          (o = _((e = p), y((t = f)))),
          (i = e.dataset.footnotePosition) !== o &&
            ((e.dataset.footnotePosition = o),
            b(e, '' + m + i),
            v(e, '' + m + o),
            (n = 100 * w(t) + '%'),
            (r = 'top' === o ? '100%' : '0'),
            (e.style.transformOrigin = n + ' ' + r)),
          p.offsetHeight < d.scrollHeight
            ? (v(p, x), d.setAttribute('tabindex', '0'))
            : (b(p, x), d.removeAttribute('tabindex')));
      },
      resize: function () {
        var e, t, n, r;
        S(p) &&
          ((p.style.left =
            ((n = f),
            (r = d.offsetWidth),
            -w(n) * r + parseInt(g.getStyle(n, 'marginLeft'), 10) + n.offsetWidth / 2 + 'px')),
          (o.style.maxWidth = d.offsetWidth + 'px'),
          (e = f),
          (t = p.querySelector('.' + u)) && (t.style.left = 100 * w(e) + '%'));
      },
  ...
  var W = function (o) {
    ...
    return function (e) {
      ...
      return (i = a === r ? i + 1 : 1), (a = r), { original: t, data: f.__assign(f.__assign({}, n), { number: i }) };
    };
  };
  function n(e) {
    var t = /<%=?\s*(\w+?)\s*%>/g;
  ...
  function R(e, t) {
    ...
    return function (e) {
      ...
      return (
        ...
        { original: t, data: n, id: r, button: i, host: o, popover: a, content: l, wrapper: c }
      );
    };
  }
  function C(e) {
          ...
          .map(
            ...
            function (e) {
              ...
              if (r) {
                l.push(r);
                var o = e.closest(u) || e;
                return { reference: o, referenceId: o.id || e.id, body: r };
              }
            })
          )
          .filter(I)
  ...
  var r = t(function (e, t) {
      e.exports = (function () {
        ...
        return (
          ...
          (e.prototype.add = function (e, t) {
            ...
            if ('string' == typeof e) {
              for (
                d[(n = { id: this.uid++, selector: e, data: t }).id] = n, c = v(this.indexes, e), r = 0;
                r < c.length;
                r++
              )
                (i = (l = c[r]).key),
          ...
          (e.prototype.queryAll = function (e) {
            ...
            for (
              ...
              for (r = l[s], t = 0, n = (o = this.matches(r)).length; t < n; t++)
                u[(a = o[t]).id]
                  ? (i = u[a.id])
                  : ((i = { id: a.id, selector: a.selector, data: a.data, elements: [] }), (u[a.id] = i), c.push(i)),
                  i.elements.push(r);
            return c.sort(m);
          }),
    ...
    N = t(function (e, t) {
      !(function (e, u) {
        ...
        function b(e, t) {
          if (!n) return;
          Object.defineProperty(e, 'currentTarget', { configurable: true, enumerable: true, get: t || n.get });
        }
        function w(e) {
          try {
            e.eventPhase;
        ...
        function o(e, t, n) {
          return e.dispatchEvent(new CustomEvent(t, { bubbles: true, cancelable: true, detail: n }));
        }
        (e.fire = o), (e.off = r), (e.on = t), Object.defineProperty(e, '__esModule', { value: true });
      })(t, r);
    }),
    B = 16,
    G = '[data-footnote-id]',
  ...
  function ee(e) {
    ...
    var t,
      ...
      l = q(C(c), c),
      s =
        ((n = $((t = l).toggle, t.dismissAll)),
        (r = J(t.dismissAll)),
        (o = d.throttle(t.repositionAll, B)),
        (i = d.throttle(t.resizeAll, B)),
        (a = Y(t.hover)),
        (u = Y(t.unhover)),
        K('touchend', n),
        K('click', n),
  ...
  (e.default = ee), (e.littlefoot = ee), Object.defineProperty(e, '__esModule', { value: !0 });
});
